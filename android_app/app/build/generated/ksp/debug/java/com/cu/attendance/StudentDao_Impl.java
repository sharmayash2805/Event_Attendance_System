...
public final class StudentDao_Impl implements StudentDao {
  ...
  public StudentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfStudentEntity = new EntityInsertionAdapter<StudentEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `students` (`uid`,`name`,`branch`,`year`,`status`,`timestamp`,`session`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(7, entity.getSession());
      }
    };
    this.__preparedStmtOfUpdateStatus = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE students SET status = ?, timestamp = ? WHERE uid = ? AND session = ?";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM students WHERE session = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updateStatus(final String session, final String uid, final String status,
      final String timestamp, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object deleteAll(final String session, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getAllStudents(final String session,
      final Continuation<? super List<StudentEntity>> $completion) {
    final String _sql = "SELECT * FROM students WHERE session = ?";
      ...
      public List<StudentEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new StudentEntity(_tmpUid,_tmpName,_tmpBranch,_tmpYear,_tmpStatus,_tmpTimestamp,_tmpSession);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getStudentByUid(final String session, final String uid,
      final Continuation<? super StudentEntity> $completion) {
    final String _sql = "SELECT * FROM students WHERE uid = ? AND session = ? LIMIT 1";
      ...
      public StudentEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpSession;
            _tmpSession = _cursor.getString(_cursorIndexOfSession);
            _result = new StudentEntity(_tmpUid,_tmpName,_tmpBranch,_tmpYear,_tmpStatus,_tmpTimestamp,_tmpSession);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object searchStudents(final String session, final String query,
      final Continuation<? super List<StudentEntity>> $completion) {
    final String _sql = "SELECT * FROM students WHERE session = ? AND (name LIKE '%' || ? || '%' OR uid LIKE '%' || ? || '%') ORDER BY name";
  ...
  @Override
  public Object getPresentCount(final String session,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM students WHERE status = 'Present' AND session = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, session);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getCount(final String session, final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM students WHERE session = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, session);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
