  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `students` (`uid` TEXT NOT NULL, `name` TEXT NOT NULL, `branch` TEXT NOT NULL, `year` TEXT NOT NULL, `status` TEXT NOT NULL, `timestamp` TEXT NOT NULL, `session` TEXT NOT NULL, PRIMARY KEY(`uid`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `offline_queue` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `action` TEXT NOT NULL, `uid` TEXT NOT NULL, `payload` TEXT, `createdAt` INTEGER NOT NULL, `session` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'be4b6248f0666e748cbf7db7d5bc3b1d')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsStudents.put("session", new TableInfo.Column("session", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsOfflineQueue = new HashMap<String, TableInfo.Column>(6);
        ...
        _columnsOfflineQueue.put("session", new TableInfo.Column("session", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "be4b6248f0666e748cbf7db7d5bc3b1d", "0a3b6bd17db7bea4332aeb194adb3f42");
