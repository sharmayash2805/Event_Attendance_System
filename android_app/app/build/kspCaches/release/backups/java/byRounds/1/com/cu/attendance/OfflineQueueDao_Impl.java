...
public final class OfflineQueueDao_Impl implements OfflineQueueDao {
  ...
  public OfflineQueueDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfOfflineQueueEntity = new EntityInsertionAdapter<OfflineQueueEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `offline_queue` (`id`,`action`,`uid`,`payload`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__preparedStmtOfClear = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM offline_queue";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object getAll(final Continuation<? super List<OfflineQueueEntity>> $completion) {
    final String _sql = "SELECT * FROM offline_queue ORDER BY createdAt ASC";
      ...
      public List<OfflineQueueEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new OfflineQueueEntity(_tmpId,_tmpAction,_tmpUid,_tmpPayload,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
